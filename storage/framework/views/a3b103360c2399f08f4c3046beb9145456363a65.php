                        ...
                        <nav id="navigation">
                            ...
                            <div class="nav-box navbar-collapse">
                                <ul class="navigation-menu nav navbar-nav navbars" id="nav">
                                    <li data-menuanchor="slide01" class="active"><a href="#slide01">Acceuil</a></li>
                                    <li data-menuanchor="slide02"><a href="#slide02">Apropos de nous</a></li>
                                    <li data-menuanchor="slide03"><a href="#slide03">Services</a></li>
                                    <li data-menuanchor="slide04"><a href="#slide04">Nos Competences</a></li>
                                    <li data-menuanchor="slide05"><a href="#slide05">Clients</a></li>
                                    <li data-menuanchor="slide06"><a href="#slide06">Testimonials</a></li>
                                    <li data-menuanchor="slide07"><a href="#slide07">Contactez-nous</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
                    <div class="welcome-box">
                        <span class="welcome-first animate" data-animate="fadeInUp">Hallo, Bienvenue a </span>
                        <h1 class="welcome-title animate" data-animate="fadeInUp">Agency Worker</h1>
                        <p class="animate" data-animate="fadeInUp">confiez le nettoyage de votre maison et de votre bureau a des professionnels.</p>
...
</html><?php /**PATH /var/www/html/siteagency/resources/views/welcome.blade.php ENDPATH**/ ?>